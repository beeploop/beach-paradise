        ...
        <div className="row experience">
            ...
            <div className="col-md-3 exp p-2">
                ...
                <div>
                    ...
                    <p className="lead p-2">
                        The restaurant offers traditional Italian fare like
                        wood-fired pizzas, homemade pasta, succulent seafood and
                        meat entrees, fresh garden salads, and cool beverages.
                    </p>
                </div>
            </div>
            ...
            <div className="col-md-3 exp p-2">
                ...
                <div>
                    ...
                    <p className="lead p-2">
                        Speed boat rides are a popular and simple water activity
                        in Goa. During this 10-minute journey, feel the rush of
                        taking on the amazing waves.
                    </p>
                </div>
            </div>
            ...
            <div className="col-md-3 exp  p-2">
                ...
                <div>
                    ...
                    <p className="lead p-2">
                        A restaurant by the sea where you can enjoy seasonal
                        seafood in elegant cuisine made with carefully chosen
                        ingredients.
                    </p>
                </div>
            </div>
